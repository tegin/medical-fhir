...
class TestMedicalEncounter(TransactionCase):
    ...
    def test_compute_impression_info_from_encounter(self):
        ...
        specialty = self.specialty_cardiology.with_context(
            **{"encounter_id": self.encounter_1.id}
        )
        self.assertEqual(specialty.patient_impression_count, 3)
        self.assertEqual(specialty.encounter_impression_count, 2)
        self.assertEqual(specialty.impressions_in_progress_count, 2)
    ...
    def test_get_specialty_impressions_from_encounter(self):
        ...
        self.assertEqual(action["context"]["default_encounter_id"], self.encounter_1.id)
